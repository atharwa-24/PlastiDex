...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    reImg1 = findViewById(R.id.reimg1);
    reImg2 = findViewById(R.id.reimg2);
    reImg3 = findViewById(R.id.reimg3);
    reImg4 = findViewById(R.id.reimg4);
    reImg5 = findViewById(R.id.reimg5);
    reImg6 = findViewById(R.id.reimg6);
    reImg7 = findViewById(R.id.reimg7);
